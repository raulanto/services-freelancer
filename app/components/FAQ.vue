...
<template>
  <section ref="sectionRef"
    class="relative w-full py-32 bg-neutral-50 dark:bg-neutral-950 overflow-hidden transition-colors duration-300">
    ...
    <div
      class="absolute inset-0 dark:bg-[radial-gradient(ellipse_60%_60%_at_50%_100%,rgba(255,255,255,0.03)_0%,transparent_70%)] bg-[radial-gradient(ellipse_60%_60%_at_50%_100%,rgba(0,0,0,0.03)_0%,transparent_70%)] pointer-events-none">
    </div>
    ...
    <div class="max-w-5xl mx-auto px-4 relative z-10">
      ...
      <div ref="titleRef" class="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
        <div>
          ...
          <h2
            class="text-4xl md:text-6xl font-serif text-neutral-900 dark:text-neutral-100 tracking-tight leading-tight transition-colors">
            Preguntas<br />
            <span class="italic text-neutral-500 dark:text-neutral-400">frecuentes</span>
          </h2>
        </div>
        <p
          class="text-neutral-600 dark:text-neutral-400 font-light max-w-xs leading-relaxed text-base md:text-right transition-colors">
          Resolvemos las dudas más comunes antes de la primera llamada para que puedas tomar decisiones con información
          real.
        </p>
      </div>
      ...
      <div class="divide-y divide-neutral-200 dark:divide-neutral-800/60 transition-colors">
        <div v-for="(faq, i) in faqs" :key="i" class="faq-item group">
          <!-- Question row -->
          <button
            ...
            <!-- Index label pill -->
            <span
              class="shrink-0 mt-0.5 text-xs font-mono text-neutral-500 dark:text-neutral-600 border border-neutral-300 dark:border-neutral-800 rounded-lg px-2 py-1 transition-colors duration-300 group-hover:border-neutral-500 dark:group-hover:border-neutral-600 group-hover:text-neutral-700 dark:group-hover:text-neutral-400">
            ...
            <!-- Category tag -->
            <span
              class="hidden md:block shrink-0 text-xs font-medium text-neutral-600 dark:text-neutral-400 bg-neutral-200 dark:bg-neutral-900 border border-neutral-300 dark:border-neutral-800 rounded-full px-3 py-1 transition-all duration-300"
            ...
            <!-- Icon -->
            <div
              class="shrink-0 w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300 mt-0.5"
              :class="openIndex === i
          ...
          <div class="faq-panel overflow-hidden h-0 opacity-0">
            <div class="pb-8 pl-[3.25rem] md:pl-[4rem]">
              <p
                class="text-neutral-600 dark:text-neutral-400 leading-relaxed text-base md:text-lg font-light max-w-3xl transition-colors">
                {{ faq.a }}
              </p>
            </div>
          </div>
      ...
      <div class="mt-20 text-center">
        <p class="text-neutral-500 dark:text-neutral-500 mb-6 text-base transition-colors">¿Tienes una pregunta
          específica que no está aquí?</p>
        <button
          ...
          <span
            class="w-6 h-6 rounded-full bg-neutral-200 dark:bg-neutral-700 group-hover:bg-neutral-300 dark:group-hover:bg-neutral-600 flex items-center justify-center transition-colors duration-300">
